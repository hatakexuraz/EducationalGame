...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dsk_pane = new javax.swing.JDesktopPane();
        ...
        jPanel2.setBackground(new java.awt.Color(175, 207, 239));

        jLabel1.setText("Select one module");
    ...
    private void btn_sdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sdActionPerformed
        GKModule sc = new GKModule();
        //this.dsk_pane.add(sc);
        sc.setVisible(true);
        sc.setLocation(dsk_pane.getWidth()-300, dsk_pane.getHeight()-300);
    ...
    private javax.swing.JDesktopPane dsk_pane;
